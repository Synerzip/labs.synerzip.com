...
?>
<section class="f-fix popular-event-wrapper" id="popular-event-wrapper">
    <div class="container">
  <div class="page-intro-block-news" >
      
            <p>Keep on top of the latest in news updates, features, press releases and resources for industry analysts and journalists. Synerzip - keeping you ahead.
             </p>
    </div>
	<div class="row">
            <?php
  ...
  <div class="next-page-wrapper">
		<div class="send-enquiry">
			<div class="enquiry-section">
				...
				<div class="arrow">	
					<a href="/team"><img src="../wp-content/uploads/2017/11/skype.png"></a>
				</div>
			</div>
		</div>
	</div>
