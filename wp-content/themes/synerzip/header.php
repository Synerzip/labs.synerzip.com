...
$whiteLogoTitles = array('home','our offerings', 'practices', 'technologies', 'our values', 'webinars', 'our team', 'stories', 'hashtag-homepage', 'careers', 'contact us', 'blogs','thank you','awards','news','event','insights');
                ...
                <div class="container">
                    <nav>
                        <div class="container-fluid" style="float:right;">
                            <form class="navbar-form navbar-left hide-on-mobile" style="border-color:transparent;" action="<?php echo get_option('home'); ?>/" role="search" method="get" id="site_search" >
                            ...
                            <ul id="contact-us" class="nav navbar-nav hide-on-mobile contact-us">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="setbar nav navbar-nav navbar-right">
                           <li class="show-on-mobile" >
							...
							<li id="stories" class="stories">
                                <a href="<?php echo $siteUrl;?>/success-stories" title="Stories">Stories</a>
                            </li>
                            <li id="technologies" class="technologies">
                                <a href="<?php echo $siteUrl;?>/technology" title="Technologies">Technologies</a>
                            </li>
                            <li id="practices" class="practices">
                                <a href="<?php echo $siteUrl;?>/practices" title="Practices">Practices</a>
                            </li>
                              <li  id="team-pg" class="dropdown team-pg">
                         <a  href="<?php echo $siteUrl;?>/team" data-toggle="dropdown" class="dropdown-toggle disabled">Team<span ><b class="caret"></b></a>
                                    <ul class="dropdown-menu" >
                                        <li  class="hide-on-mobile1" ><a href="<?php echo $siteUrl;?>/values">Values</a></li>
                                        <li  class="hide-on-mobile1" ><a href="<?php echo $siteUrl;?>/awards"> Awards</a></li>
                                   </ul>
                            </li>
                            <li class="show-on-mobile1" >
                               <a href="<?php echo $siteUrl;?>/values" style="color:#a59c9c;"> values</a>

                            </li>
                            <li class="show-on-mobile1">
                                <a href="<?php echo $siteUrl;?>/awards" style="color:#a59c9c;"> Awards</a>
                            </li>
                            <li id="insights" class="dropdown insights">
                                <a href="<?php echo $siteUrl;?>/insights" data-toggle="dropdown" class="dropdown-toggle disabled">Insights<b class="caret"></b></a>
                                    <ul class="dropdown-menu">
                                        <li class="hide-on-mobile1"><a href="<?php echo $siteUrl;?>/webinars">Webinars</a></li>
                                        <li class="hide-on-mobile1"><a href="<?php echo $siteUrl;?>/blogs">Blogs</a></li>
                                       <!--  <li class="hide-on-mobile1"><a href="<?php echo $siteUrl;?>/event">Events</a></li> -->
                                        <li class="hide-on-mobile1"><a href="<?php echo $siteUrl;?>/news">News</a></li>
                                    </ul>
                            </li>
                                        <li  class="show-on-mobile1"><a href="<?php echo $siteUrl;?>/webinars" style="color:#a59c9c;">Webinars</a></li>
                                        <li  class="show-on-mobile1"><a href="<?php echo $siteUrl;?>/blogs" style="color:#a59c9c;">Blogs</a></li>
                                        <!-- <li  class="show-on-mobile1"><a href="<?php echo $siteUrl;?>/event" style="color:#a59c9c;">Events</a></li> -->
                                        <li  class="show-on-mobile1"><a href="<?php echo $siteUrl;?>/news" style="color:#a59c9c;">News</a></li>
                            <li id="career"  class="career">
                                <a  href="<?php echo $siteUrl;?>/career" title="Careers">Careers</a>
                            </li>
                            <li class="show-on-mobile" >
                                <a href="<?php echo $siteUrl;?>/contact"  title="Contact" >Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    if (isset($large_image_url) && !empty($large_image_url)) {
        ...
        elseif (is_page('hashtag-homepage')) {
            ...
            ?>
                    ...
                    <form class="navbar-form navbar-left hide-on-mobile siq_searchForm" style="border-color: transparent;" action="http://synerzip.production.com/" role="search" method="get" id=     "site_search">
                            <div class="input-group search-content">
                               <input name="s" id="s" class="form-control siq_searchBox siq_searchIndex-3" placeholder="Search" autocomplete="off" type="text">
                                    <div class="input-group-btn">
                                        <button class="btn btn-default-search " type="submit">
                                        <i class="fa fa-search" aria-hidden="true"></i>
                                        </button>
