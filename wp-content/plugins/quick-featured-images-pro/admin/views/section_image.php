<h2><?php _e( 'Your selection', 'quick-featured-images-pro' ); ?></h2>
<?php
$two_columns = false;
...
<div class="qfi_wrapper">
	<div class="qfi_w50percent">
		<h3><?php _e( 'Your selected thumbnail', 'quick-featured-images-pro' ); ?></h3>
		<p>
...
<div class="qfi_wrapper">
	<div class="qfi_w50percent">
		<h3><?php _e( 'Your selected thumbnails', 'quick-featured-images-pro' ); ?></h3>
...
?>
		<h3><?php _e( 'Your selected action', 'quick-featured-images-pro' ); ?></h3>
<?php
...
?>
		<h3><?php _e( 'Your selected approach', 'quick-featured-images-pro' ); ?></h3>
...
<div class="qfi_wrapper">
	<div class="qfi_w50percent">
		<h3><?php _e( 'Your selected options', 'quick-featured-images-pro' ); ?></h3>
<?php 
...
?>
	...
	<div class="qfi_w50percent">
		<h3><?php _e( 'Your selected filters', 'quick-featured-images-pro' ); ?></h3>
<?php 
