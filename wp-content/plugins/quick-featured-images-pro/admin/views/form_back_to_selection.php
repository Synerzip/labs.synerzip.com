...
<h2><?php _e( 'Select filters and options again', 'quick-featured-images-pro' ); ?></h2>
<p><?php _e( 'If you want to change your former selection just go back by clicking on this button.', 'quick-featured-images-pro' ); ?></p>
...
?>
		...
		<input type="submit" class="button" value="<?php _e( 'Modify selection', 'quick-featured-images-pro' ); ?>" />
	</p>
</form>